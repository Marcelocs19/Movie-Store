...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User user1 = new User("userMaria","maria@gmail.com", "1234");
		User user2 = new User("userPaul","paulB@gmail.com", "1234");
		User user3 = new User("userBob","bob@gmail.com", "1234");
		User user4 = new User("userJohn","johnD@gmail.com", "1234");
		User user5 = new User("userAriel","arial@gmail.com", "1234");
